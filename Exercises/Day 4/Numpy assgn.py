...
print(np.arange(10.,49.,3))

#### 8. Reverse a vector (first element becomes last) (★☆☆)
array= np.arange(10.,49.,3)
print(array[::-1])
...
date= np.arange('2021-07-01', '2021-08-01', dtype='datetime64[D]')
print(date)
...
result= (np.sum(A+B))*((np.negative(A))/2)
...
array= np.fromiter((x*x for x in range(10)),int)
print(array)


#### 39. Create a vector of size 10 with values ranging from 0 to 1, both excluded (★★☆)

array= np.linspace(0.00001,0.99999,10)
print(array)
...
array= np.array([1,2,3,4])
array1= np.array([5,3,4,8])

print(np.allclose(array,array1))
print(np.array_equal(array,array1))
